...
document.getElementById('apply-filter').addEventListener("click",()=>{
  ...
  <button type="button" class="size-btn hover:scale-110 border-2 px-2 hover:cursor-pointer transform transition duration-150 mx-1" data-size="${sizeObj.size}">
    ${sizeObj.size} 
  </button>`).join('');
